...
void *thread_function(void *arg){
    ...
    write(args.new_socket, args.hello , strlen(args.hello));
...
int main(int argc, char const *argv[])
{
    ...
    while(1)
    {
        ...
        // printf("-------------Hello message sent---------------");
        // close(new_socket);
        thread_args args = {hello , new_socket} ; 
        int thread_situation = pthread_create(&thread_x , NULL , *thread_function , &args);
    }
    return 0;
}
